"""A hello-world filter plugin in sshedmake_namespace_35.myrhdh_35."""
...
DOCUMENTATION = """
    name: hello_world
    author: Sshedmake_namespace_35 Myrhdh_35
    version_added: "1.0.0"
...
- name: Display a hello message
  ansible.builtin.debug:
    msg: "{{ 'ansible-creator' | sshedmake_namespace_35.myrhdh_35.hello_world }}"
"""
